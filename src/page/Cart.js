      ...
      <div className="p-2 md:p-4">
        ...
        <div className="my-4 flex gap-3">
          ...
          <div className="w-full max-w-md  ml-auto">
            ...
            {/* <button className="bg-red-500 w-full text-lg font-bold py-2 text-white" onClick={handlePayment}>
              Payment <span style={{fontSize:"10px"}}>(Via Debit Card)</span> 
            </button> */}
            <button className="bg-red-500 w-full text-lg font-bold py-2 text-white mt-2" onClick={handleCash}>
              Payment
            </button>
          </div>
        </div>
        ...
        <>
          <div className="flex w-full justify-center items-center flex-col">
            <img src={emptyCartImage} className="w-full max-w-sm" alt='pic'/>
