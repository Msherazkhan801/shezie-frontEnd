...
const sidebarItems = [
  [
    { id: '0', title: 'Dashboard',path:'/dashboard', notifications: false },
    { id: '1', title: 'Product Detail',path:'/order-product-detail', notifications: false },
    { id: '2', title: 'Team', notifications: false },
  ],
...
const Dashboard = () => {
  ...
  return (
    <div className="flex font-nunito text-gray-600 bg-azure">
      <Sidebar
      userData={userData}
        onSidebarHide={() => {
...
function Sidebar({ onSidebarHide, showSidebar,userData }) {
    ...
    >
        ...
        <div className="w-full p-3 h-24 sm:h-20 xl:h-24 hidden sm:block flex-shrink-0">
          <div className="bg-sidebar-card-top rounded-xl w-full h-full flex items-center justify-start sm:justify-center xl:justify-start px-3 sm:px-0 xl:px-3">
            ...
            <div className="block sm:hidden xl:block ml-3">
              <div className="text-sm font-bold text-grey-900">Sales House</div>
          ...
          >
            <div className="block sm:hidden xl:block pt-3">
              ...
              <div className="text-gray-500 text-xs">
                Admin updated 09:12 am july 14,2023
              </div>
      ...
      <div className="flex-shrink-0 overflow-hidden p-2">
        <div className="flex items-center h-full sm:justify-center xl:justify-start p-2 sidebar-separator-bottom">
          <Image path="mock_faces_8" className="w-10 h-10"  userData={userData}/>
...
function MenuItem({ item: { id, title, notifications }, Rlink,onClick, selected }) {
    console.log(Rlink,"link");
  return (
    <div
      className={clsx(
        'w-full mt-6 flex items-center px-3 sm:px-0 xl:px-3 justify-start sm:justify-center xl:justify-start sm:mt-6 xl:mt-3 cursor-pointer',
        selected === id ? 'bg-green-600 text-grey-600 sidebar-item-selected' : 'sidebar-item',
      )}
      onClick={() => onClick(id)}
    >
      <SidebarIcons id={id} />
     <Link to={Rlink ? Rlink :'/dashboard'}> <div className="block sm:hidden xl:block ml-2">{title}</div></Link>
      <div className="block sm:hidden xl:block flex-grow" />
      {notifications && (
...
function Content({ onSidebarHide,data }) {
  const userData = useSelector((state) => state.user);
          ...
          <div className="sm:flex-grow flex justify-between">
            <div className="">
              <div className="flex items-center">
                <div className="text-3xl font-bold text-gery=600">Hello  ({userData.firstName})</div>
              ...
              <div className="flex items-center">
                <Icon
                  ...
                  className="w-3 h-3"
                />
                <div className="ml-2">{currentDate.toDateString()}</div>
              </div>
            </div>
            <IconButton
  ...
  const totalPrice = cartItems.reduce(
    ...
    <div className="rounded-xl overflow-hidden tooltip-head">
      ...
      <div className="tooltip-body text-center p-3">
        <div className="text-white font-bold">${totalPrice}</div>
        <div className="">Revenue from 100 sales</div>
      </div>
    </div>
  );
  return (
    <div className="flex p-4 h-full flex-col">
      <div className="">
        <div className="flex items-center">
          <div className="font-bold text-grey-600">Your Work Summary</div>
          <div className="flex-grow" />

          <Icon path="res-react-dash-graph-range" className="w-4 h-4" />
          <div className="ml-2">Last 9 Months</div>
          <div className="ml-6 w-5 h-5 flex justify-center items-center">
           ${totalPrice}
          </div>
        </div>
...
function Segmentation() {
  return (
    <div className="p-4 h-full">
      <div className="flex justify-between items-center">
        <div className="text-grey-600 font-bold">Segmentation</div>
...
function Satisfication() {
 ...
 const totalPrice = cartItems.reduce(
  ...
  return (
    <div className="p-4 h-full">
      <div className="flex justify-between items-center">
        <div className="text-grey font-bold">Satisfication</div>
        {/* <Icon path="res-react-dash-options" className="w-2 h-2" /> */}
      </div>
...
function Image({ path = '1', className = 'w-4 h-4' ,userData }) {
    console.log(userData,"image");
  return (
    <img
      src={userData ? userData?.image:`https://assets.codepen.io/3685267/${path}.jpg`}
      alt=""
      className={clsx(className, 'rounded-full')}
    />
  );
}
function CustomeTable({data}){
  ...
  {currentData.map((ele)=>{
    return(
   <tr key={ele.id}>
 <td className="text-left w-[120px]">{ele.fname}{ele.lname}</td>
